...
//
// * A prelude file `browserify.js`, containing all of Browserify's `require` definitions, plus its built-in modules
//   (viz. `path` and `process`).
...
// * Any handler scripts specified by the `browserifyHandlers` module.
// * Wrapped module files for the entry file and all its dependencies, recursively.
//
